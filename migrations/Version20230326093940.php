 ...
 */
final class Version20230326093940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_step CHANGE content content LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_step CHANGE content content VARCHAR(255) NOT NULL');
    }
}
